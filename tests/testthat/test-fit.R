  ...
  expect_equal(
    {
      ...
      list(
        Harrel.C.Index = round(0.602903,7),
        Uno.C.Index = round(0.5960294, 7),
        iAUC = round(0.6446272, 7),
        iAUC.IQR = round(0.6174132,7),
        iAUC.Q10.Q90 =  round(0.6407606,7),
        ...
        IAE = round(14.6904,7),
        ISE = round(0.3388,7),
        IAE.IQR = round(54.9943,7),
        ISE.IQR = round(6.9539,7),
        IAE.Q10.Q90 = round(19.1671,7),
        ISE.Q10.Q90 = round(0.7022,7),
